...
/*
* Bài 11: Hãy nhập 4 số nguyên a, b, c, d. Tìm giá trị nhỏ nhất của chúng và gán giá trị
* lớn nhất đó cho biến min. In giá trị min tìm được ra màn hình. Trong trường
